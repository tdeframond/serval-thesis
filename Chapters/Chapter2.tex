...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{serval-logo1}
\caption{Serval Logo}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{mesh-app}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{mesh-extender-v1}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.80\textwidth]{pacific}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{moule}
